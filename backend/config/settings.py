"""
Django settings for the OpenOnCall project.

Single, environment-variable-driven settings module (see build spec Section 12
for the full list of supported environment variables and Phase 0's DoD).
"""
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://openoncall:openoncall@localhost:5432/openoncall",
    )
}
...
# --- Twilio (bring-your-own-account, never shared/proxied) -------------------
...
# --- Slack ---------------------------------------------------------------------
# Per-team Incoming Webhook URLs live on the Team model, not here.
# The signing secret below is instance-wide: it verifies inbound Slack
# interactivity callbacks (the "Acknowledge" button), which is a single
# Slack App registration for the whole self-hosted instance.
